...
#define EP_WEATHER_PROVIDER_OPEN_METEO 1
// Keep the persisted provider value compatible with existing installations.
#define EP_WEATHER_PROVIDER_GOOGLE EP_WEATHER_PROVIDER_OPEN_METEO
...
#define EP_WEATHER_WM_CAPTURE_DATA (WM_USER + 17)
#define EP_WEATHER_WM_SET_NATIVE_THEME (WM_USER + 18)
#define EP_WEATHER_WM_SYNC_THEME (WM_USER + 20)
...
#define EP_WEATHER_THEME_SYSTEM 0
#define EP_WEATHER_THEME_LIGHT 1
#define EP_WEATHER_THEME_DARK 2
#endif
